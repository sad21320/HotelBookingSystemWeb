...
namespace HotelBookingSystemWeb.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomID,RoomNumber,Floor,Status,CreatedDate,RoomTypeID")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomID,RoomNumber,Floor,Status,CreatedDate,RoomTypeID")] Room room)
        {
            if (id != room.RoomID)
            {
                return NotFound();
